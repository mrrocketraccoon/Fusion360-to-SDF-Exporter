...
#                            print(two.name)
                            ...
                            if link_parent is None or link_child is None:
                                ui.messageBox('Please include all objects in rigid groups!')
                                return 0
